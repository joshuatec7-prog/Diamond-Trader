...
COLLECTOR = PROJECT_DIR / "early_entry_collector_v1_3_1.py"
...
def self_test() -> None:
    ...
    print("EARLY_ENTRY_RUNNER_V1_1_SELF_TEST_OK")
...
def run_forever() -> int:
    ...
    while not STOP_REQUESTED:
        ...
        log(f"Collector starten | restart_count={restart_count}")
        ...
        try:
            ...
            log(f"FOUT bij starten collector | {type(exc).__name__}: {exc}")
            CHILD = None
