#!/usr/bin/env python3
"""
Diamond Trader Early Entry Collector v1.3.1
...
CSV_FILE = DATA_DIR / "early_entry_samples_v1_3_1.csv"
STATE_FILE = DATA_DIR / "early_entry_state_v1_3_1.json"
        ...
        for attempt in range(HTTP_RETRIES + 1):
            ...
            request = urllib.request.Request(
                ...
                headers={
                    ...
                    "User-Agent": (
                        "DiamondTrader-EarlyEntry/1.3.1 "
                        "(public-read-only)"
                    ),
                    "Connection": "close",
                },
...
def self_test() -> None:
    ...
    assert "start=1000" in trade_url
    assert "end=2000" in trade_url

    print(
        "EARLY_ENTRY_COLLECTOR_V1_3_1_SELF_TEST_OK"
    )
    print(
        f"Versie                 : {VERSION}"
    )
