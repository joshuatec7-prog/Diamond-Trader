...
echo "[START] Diamond Early Mover Hot Watch"
python3 diamond_early_mover_hot_watch.py --loop \
    >> "$EARLY_MOVER_HOT_LOG" 2>&1 &
EARLY_MOVER_HOT_PID=$!
OPTIONAL_PIDS+=("$EARLY_MOVER_HOT_PID")
echo "        PID $EARLY_MOVER_HOT_PID"
