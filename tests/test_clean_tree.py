...
class TreeTests(unittest.TestCase):
    def test_only_expected_project_files_exist(self):
        ...
        allowed_top = {
            ...
            'continuation_v6_main.py','crypto_scanner.py','crypto_scanner_v2.py','crypto_research_v4.py','exit_capture_lab.py','exit_capture_1m_lab.py','funding_basis_monitor.py','low_frequency_lab.py','main.py','market_data.py','models.py','missed_trade_audit.py',
