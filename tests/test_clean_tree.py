...
class TreeTests(unittest.TestCase):
    def test_only_expected_project_files_exist(self):
        ...
        allowed_top = {
            ...
            'audit_all.py','auto_research_controller.py','backtest.py','bitvavo_public.py','config.py',
            ...
            'offline_check.py','paper_trader.py','profit_protect_trader.py','readiness.py','report.py',
            'requirements.txt','staged_runner_trader.py','start.sh','status.py','storage.py','strategy.py',
            'supervisor.py','trend_main.py','trend_strategy.py','trend_v3_main.py','trend_v4_main.py',
            'trend_v5_main.py','trend_v6_main.py','trend_v7_main.py','tests'
        }
