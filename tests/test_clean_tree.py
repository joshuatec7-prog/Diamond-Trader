...
class TreeTests(unittest.TestCase):
    def test_only_expected_project_files_exist(self):
        ...
        allowed_top = {
            ...
            'adaptive_ls_main.py','adaptive_ls_strategy.py','adaptive_ls_trader.py','autonomous_v36.py','autonomous_v37.py','autonomous_v38.py','autonomous_v39.py','autonomous_v40.py',
            ...
            'continuation_v6_main.py','crypto_scanner.py','crypto_scanner_v2.py','crypto_research_v4.py','exit_capture_lab.py','exit_capture_1m_lab.py','funding_basis_monitor.py','human_decision.py','low_frequency_lab.py','main.py','market_data.py','models.py','missed_trade_audit.py',
            ...
            'trend_v6_main.py','trend_v7_main.py','v36_decision.py','v37_decision.py','v38_discovery.py','v38_audit.py',
            'v40_historical_lab.py','v40_human_engine.py','v40_marketwide_audit.py','v40_master_research_dataset.py','v40_offline_scan.py','v40_replay.py','v40_soft_memory_lab.py','v40_score_dataset_export.py','research','tests'
        }
