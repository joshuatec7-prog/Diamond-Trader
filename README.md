...
`crypto_scanner_v2.py` bevat nu scanner v3. Een handmatig kanslabel vereist een uitvoerbare €200-L2-VWAP,
...
worden prospectief opgeslagen in `cryptobot_scanner_v3.db`.
